...
public class WeekBarView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mWeekTextColor1 = array.getColor(R.styleable.WeekBarView_week_text_color1, Color.parseColor("#ff4040"));
        mWeekTextColor2 = array.getColor(R.styleable.WeekBarView_week_text_color2, Color.parseColor("#d4d4d4"));
    ...
    private void initPaint() {
        ...
        mPaint = new Paint();
        mPaint.setColor(mWeekTextColor1);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mWeekString.length; i++) {
            if(i==0){
                ...
                mPaint.setColor(mWeekTextColor2);
            }
